...
- **Commands:** `dk-map-domain` (start session), `dk-sync-domain-diagram` (regenerate diagram from domain.md).
...
- `commands/dk-map-domain.md` — start knowledge-map session.
- `commands/dk-sync-domain-diagram.md` — sync diagram from domain.md.
