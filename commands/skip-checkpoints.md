...
- **Phase 2:** Data discovery. Optionally use subagent for 2a–2c or 2e (see `discover-tables`, `run-lineage`).
- **Phase 3:** Data mapping.
- **Phase 4:** Query design.
- **Phase 5:** EXPLAIN and safe run. Optionally use subagent (see `explain-query`).
