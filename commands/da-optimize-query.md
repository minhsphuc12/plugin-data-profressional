...
**Optimize** an existing query based on EXPLAIN PLAN. Use when you already have EXPLAIN output (e.g. from da-explain-query) and want to apply tuning without re-running the full workflow.
