...
Create the **data mapping document** only. Use when you already have a task brief and a confirmed list of tables/columns (e.g. after da-discover-tables and **[CHECKPOINT 2]**).
